        ...
        public void BookGuest(string firstName, string lastName, DateTime startDate, DateTime endDate, int roomTypeId)
        {
            ...
            _db.SaveData("spBookings_Insert",
                         new
                         {
                             ...
                             startDate = startDate,
                             endDate = endDate,
                             totaCost = timeStaying.Days * roomType.Price
                         },
                         connectionStringName,
                         true);
        }
        public List<RoomModel> SearchBookings(string lastName)
        {
            return _db.LoadData<RoomModel, dynamic>("dbo.spBookings_Search",
                                                    new { lastName, DateTime.Now.Date },
                                                    connectionStringName,
                                                    true);
        }
